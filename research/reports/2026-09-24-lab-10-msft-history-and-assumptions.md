...
### Organic growth learning note

**Organic growth** is growth generated by the continuing business, normally excluding the effect of acquisitions, divestitures, and sometimes foreign-currency movements. **Same-store sales** is a narrower retail version: it compares only locations operating in both periods.

Microsoft does not disclose a consolidated organic-growth or same-store-sales measure in these FY2024-FY2026 MD&A sections. Its Azure and other cloud-services growth is a useful operating KPI, but it is not a substitute because it covers only part of Microsoft and is not labeled organic growth.

The ABG tutorial carries **1.8% organic growth** even though reported growth was **4.7%** because the base case separates the growth expected from continuing operations from reported growth that can include portfolio, acquisition, or other non-repeatable effects. That makes the model's revenue driver a forecast of the existing business rather than a mechanical repeat of one reported growth number.
